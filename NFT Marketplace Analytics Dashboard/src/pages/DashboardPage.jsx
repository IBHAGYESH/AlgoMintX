...
import { Search, Image, Users, DollarSign, Tag, Activity, Wifi, WifiOff, Sun, Moon, Github, Home } from 'lucide-react';
        ...
        <div className="container">
          <div className="header-content">
            <div className="header-left">
              <Link to="/" className="logo" aria-label="AlgoMintX — back to landing page">
                <Image size={24} />
                <h1>AlgoMintX</h1>
              </Link>
            </div>
        ...
        <div className="container">
          <div className="footer-content">
            ...
            <div className="footer-links">
              <a href={NPM_URL} target="_blank" rel="noopener noreferrer" className="footer-link">
                <NpmLogo size={16} />
                npm Package
              </a>
